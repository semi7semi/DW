...
class GameResultsAdmin(admin.ModelAdmin):
    list_display = ("user", "army", "battle_points", "objective", "objective_type", "game_rank", "opponent", "date")
    list_editable = ("army", "battle_points", "objective", "objective_type", "game_rank", "opponent", "date")
